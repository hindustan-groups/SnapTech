...
export default function TermsOfServicePage() {
  ...
  return (
    <>
      <SEO
        title={page?.title ? `${page.title} | SnapTech Digital` : 'Terms of Service | SnapTech Digital'}
        description="Terms of service and enterprise contract conditions for working with SnapTech Digital."
          ...
          <div className="max-w-3xl mx-auto bg-white border border-slate-200/80 rounded-3xl p-6 sm:p-10 shadow-sm">
            {isLoading ? (
              ...
              <div className="text-center py-10 space-y-3">
                ...
                <p className="font-semibold text-slate-800">Failed to load terms</p>
