...
export default function RefundPolicyPage() {
  ...
  return (
    <>
      <SEO
        title={page?.title ? `${page.title} | SnapTech Digital` : 'Refund Policy | SnapTech Digital'}
        description="Refund policy and cancellation terms for engineering services with SnapTech Digital."
        path="/refund-policy"
        noIndex
      />
